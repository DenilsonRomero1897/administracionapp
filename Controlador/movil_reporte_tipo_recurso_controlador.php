...
class myPDF extends FPDF
{
    function header()
    {
        ...
        $this->Cell(330, 10, utf8_decode("REPORTE DE MANTENIMIENTO  TIPO RECURSO"), 0, 0, 'C');
        $this->ln(17);
        $this->SetFont('Arial', '', 12);
        $this->Cell(60, 10, utf8_decode(" RECURSOS EXISTENTES"), 0, 0, 'C');
    ...
    function headerTable()
    {
        ...
        $this->Cell(140, 7, utf8_decode("URL"), 1, 0, 'C');
        $this->ln();
    }
    function viewTable()
    {
        ...
        while ($reg = $stmt->fetch_array(MYSQLI_ASSOC)) {
            ...
            $this->Cell(140, 7, utf8_decode($reg['url']), 1, 0, 'C');
