  ...
  <div class="content-wrapper">
    ...
    <div class="card card-default">
      <div class="card-header">
          <a class="btn btn-primary btn-xs" href="../vistas/movil_crear_usuario_segmento_vista.php">Nuevo</a>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="tabla" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
            $sql_segmentos = "select * from tbl_movil_segmento_usuario";
            $resultado_segmentos = $mysqli->query($sql_segmentos);
            while ($segmento = $resultado_segmentos->fetch_array(MYSQLI_ASSOC)) { ?>
              <tr>
                <td><?php echo $segmento['usuario_id']; ?></td>
                <td><?php echo $segmento['segmento_id']; ?></td>
