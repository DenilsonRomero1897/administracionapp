...
<body>
    <div class="content-wrapper">
        ...
        <div class="w-auto">
            ...
            <!-- pagina chats -->
                <div class="col-span-1 bg-gray-700 bg-opacity-80 border-r border-gray-300">
                    <div class="my-3 mx-3 ">
                    ...
                    <ul class="overflow-auto bg-blue-400" style="height: 500px;">
                        <h2 class="ml-2 mb-2 text-black text-lg my-2">Chats</h2>
                        <li>
                            ...
                            <a class="hover:bg-gray-100 border-b border-gray-300 px-3 py-2 cursor-pointer flex items-center text-sm focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out">
                                <img class="h-10 w-10 rounded-full object-cover" src="https://images.pexels.com/photos/6238133/pexels-photo-6238133.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260" alt="username" />
                                <div class="w-full pb-2">
                                    <div class="flex justify-between">
                ...
                <div class="col-span-2 bg-white">
                    <div class="w-full">
                        ...
                        <div class="w-full py-3 px-3 flex items-center justify-between border-t border-gray-300">
                            ...
                            <input aria-placeholder="Escribe un mensaje aquí" placeholder="Escribe un mensaje aquí" class="py-2 mx-3 pl-5 block w-full rounded-full bg-gray-100 outline-none focus:text-gray-700" type="text" name="message" required />
