            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1>Crear Ubicación del Recurso</h1>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="../vistas/movil_menu_mantenimiento_vista.php">Menu Mantenimiento APP</a></li>
                ...
                <form action="../Controlador/guardar_estado_civil_controlador.php" method="post" data-form="save" class="FormularioAjax" autocomplete="off">
                    ...
                    <div class="card card-default ">
                        <div class="card-header center">
                            <h3 class="card-title">Nueva Ubicación del Recurso</h3>
