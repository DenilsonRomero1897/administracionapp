  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Nuevo Usuario del Segmento</h1>
          </div>
        ...
        <form action="../Controlador/guardar_segmento_controlador.php" method="POST" >
          ...
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">Crear Nuevo Usuario para el Segmento</h3>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label for="descripcion">Nombre para el usuario del Segmento</label>
